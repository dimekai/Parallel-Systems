...
Este programa genera **`N`** elementos aleatorios y los guarda en un arreglo **`datos`**. Las tareas principales son crear cuatro procesos distintos para:
	...
	3. Calcular el promedio del conjunto de valores en el arreglo.
	4. 
...
En un principio los valores que se generan siempre son los mismos

Para evitar eso vamos a usar un srand


Ahora la primer tarea es:
- Hacer un programa que genere cuatro procesos hijos y un conjunto de 128 valores enteros. Cada proceso ejecutará los siguientes algoritmos.
